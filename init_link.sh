...
sudo ovs-ofctl add-flow s2 ip,priority=65500,in_port=2,nw_dst=10.0.0.4,idle_timeout=0,actions=output:3,normal
sudo ovs-ofctl add-flow s2 ip,priority=65500,in_port=2,nw_dst=10.0.0.5,idle_timeout=0,actions=output:4,normal

sudo ovs-ofctl add-flow s3 ip,priority=65500,in_port=1,nw_dst=10.0.0.6,idle_timeout=0,actions=output:3,normal
sudo ovs-ofctl add-flow s3 ip,priority=65500,in_port=1,nw_dst=10.0.0.7,idle_timeout=0,actions=output:4,normal

sudo ovs-ofctl add-flow s3 ip,priority=65500,in_port=2,nw_dst=10.0.0.6,idle_timeout=0,actions=output:3,normal
sudo ovs-ofctl add-flow s3 ip,priority=65500,in_port=2,nw_dst=10.0.0.7,idle_timeout=0,actions=output:4,normal